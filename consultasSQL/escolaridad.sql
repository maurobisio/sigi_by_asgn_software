SELECT usuario.ci, usuario.primer_nombre, usuario.segundo_nombre, materia.nom_materia, grupo.nombre_grupo, registro.valor
FROM (((((((tipo_registro
...
WHERE tipo_registro.nom_registro = 'Calificación Final' AND rol.nombre_rol = 'Alumno/a' AND usuario.ci = '5'
